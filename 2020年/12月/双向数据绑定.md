  ...
  <script>
    ...
    class Watcher {
      ...
      update() {
        ...
        // console.log(this.node.nodeValue, 'this.node.nodeValue')
    ...
    function Compile(el, vue, data) {
      ...
      el.childNodes.forEach((child) => Compile(child, vue, data))
    }
    ...
    //   juice: 'juice',
    // }
    // defineReactive(data, 'juice', 'juice') // 劫持数据

    // // 自己手动触发 Watcher 触发getter
    // new Watcher(window, 'data.juice', (res, value, oldValue) => {
    //   console.log(res, value, oldValue, '这是一个Watcher')
    // })
